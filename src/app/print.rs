...
// const ALT: &str = r" ___      ___   __      ________  __     ________    _______      ___
// ___       __       ______    _______     ______    ________ |'  \    /'  | |' \    /'       )|' \
// |'      '\  /'     '|    |'  \    /'  |     /''\     /' _  '\  /'      \   /    ' \  /'       )
//  \   \  //   | ||  |  (:   \___/ ||  |  (.  ___  :)(: ______)     \   \  //   |    /    \   (: (
// \___)|:        | // ____  \(:   \___/  /\\  \/.    | |:  |   \___  \   |:  |  |: \   ) || \/    |
// /\\  \/.    |   /' /\  \   \/ \     |_____/   )/  /    ) :)\___  \ |: \.        | |.  |    __/
// \\  |.  |  (| (___\ || // ___)_     |: \.        |  //  __'  \  //  \ _   //      /(: (____/ //
// __/  \\ |.  \    /:  | /\  |\  /' \   :) /\  |\ |:       :)(:      '|    |.  \    /:  | /   /  \\
// \(:   _) \ |:  __   \ \        /  /' \   :) |___|\__/|___|(__\_|_)(_______/ (__\_|_)(________/
// \_______)    |___|\__/|___|(___/    \___)\_______)|__|  \___) \'_____/  (_______/";
pub fn line_up() {
    print!("\r\x1b[1A");
}
